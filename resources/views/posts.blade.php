<x-layout>
    ...
    <form id="search" action="{{ route('posts.search') }}" method="GET" class="max-w-md mx-auto pt-5">
        <label for="search" class="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Search</label>
        <div class="relative flex">
            <!-- Dropdown Menu -->
            <div class="relative">
                <select id="dropdown" name="dropdown" class="block p-4 text-sm text-gray-900 border border-gray-300 rounded-l-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
