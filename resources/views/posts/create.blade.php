<x-layout>
    <div class="max-w-md mx-auto">
        <h1 class="text-4xl text-white font-sans my-4 text-left">Create a post</h1>
        <form action="{{ url(route('posts.store')) }}" method="POST">
            ...
            <div class="relative z-0 w-full mb-5 group">
                <select id="tag" name="tag" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" required>
                    ...
                    <option class="bg-gray-900" value="Pathfinder">Pathfinder</option>
                    <option class="bg-gray-900" value="Reaper Miniatures">Reaper Miniatures</option>
                    <option class="bg-gray-900" value="Custom Made">Custom Made</option>
